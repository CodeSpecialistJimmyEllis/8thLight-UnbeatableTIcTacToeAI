                ...
                if ((TicTacToeAI.TurnPiece.xturn ==  tictactoeAI.P_Turnpiece) && (TicTacToeAI.Winner.nowins == tictactoeAI.P_Winner))
            {
               ...
               // if (Mouse.GetState().LeftButton == ButtonState.Presed && gameMouse.
                ...
                if(Mouse.GetState().LeftButton == ButtonState.Pressed)
                {
                    ...
                    if (tictactoeAI.BoxCollisionRect[0].Intersects(mouseCollision) && (tictactoeAI.LocationUsedByO[0, 0] == false) && (tictactoeAI.LocationUsedByX[0,0] == false) && (tictactoeAI.IsLocationUsed[0,0] == false) )
                    {
                    ...
                    else if (tictactoeAI.BoxCollisionRect[1].Intersects(mouseCollision) && (tictactoeAI.LocationUsedByO[0, 1] == false) && (tictactoeAI.LocationUsedByX[0, 1] == false) && (tictactoeAI.IsLocationUsed[0, 1] == false))
                    {
                    ...
                    else if (tictactoeAI.BoxCollisionRect[2].Intersects(mouseCollision) && (tictactoeAI.LocationUsedByO[0, 2] == false) && (tictactoeAI.LocationUsedByX[0, 2] == false) && (tictactoeAI.IsLocationUsed[0, 2] == false))
                    {
                ...
                else if (tictactoeAI.BoxCollisionRect[3].Intersects(mouseCollision) && (tictactoeAI.LocationUsedByO[1, 0] == false) && (tictactoeAI.LocationUsedByX[1, 0] == false) && (tictactoeAI.IsLocationUsed[1, 0] == false))
                {
                ...
                else if (tictactoeAI.BoxCollisionRect[4].Intersects(mouseCollision) && (tictactoeAI.LocationUsedByO[1, 1] == false) && (tictactoeAI.LocationUsedByX[1, 1] == false) && (tictactoeAI.IsLocationUsed[1, 1] == false))
                {
                ...
                else if (tictactoeAI.BoxCollisionRect[5].Intersects(mouseCollision) && (tictactoeAI.LocationUsedByO[1, 2] == false) && (tictactoeAI.LocationUsedByX[1, 2] == false) && (tictactoeAI.IsLocationUsed[1, 2] == false))
                {
                ...
                // the third row
                else if (tictactoeAI.BoxCollisionRect[6].Intersects(mouseCollision) && (tictactoeAI.LocationUsedByO[2, 0] == false) && (tictactoeAI.LocationUsedByX[2, 0] == false) && (tictactoeAI.IsLocationUsed[2, 0] == false))
                {
                ...
                else if (tictactoeAI.BoxCollisionRect[7].Intersects(mouseCollision) && (tictactoeAI.LocationUsedByO[2, 1] == false) && (tictactoeAI.LocationUsedByX[2, 1] == false) && (tictactoeAI.IsLocationUsed[2, 1] == false))
                {
                ...
                else if (tictactoeAI.BoxCollisionRect[8].Intersects(mouseCollision) && (tictactoeAI.LocationUsedByO[2, 2] == false) && (tictactoeAI.LocationUsedByX[2, 2] == false) && (tictactoeAI.IsLocationUsed[2, 2] == false))
                {
